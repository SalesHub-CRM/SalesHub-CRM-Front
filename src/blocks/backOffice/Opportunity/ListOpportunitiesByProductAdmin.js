...
import {ListOpportunitiesByProductFunction} from "../../../redux/actions/OpportunitiesActions";
...
const ListOpportunitiesByProductAdmin = () => {
            ...
            <div className="DashboardHome">
                <div className="container mt-5">
                    <div className="row d-flex justify-content-center align-items-center h-100">
                        <div className="col-xl-10">
                            <div>
                                <h1 className="mt-5 text-center" style={{marginBottom:"200px"}}>There are currently no opportunities associated with this product.</h1>
                    ...
                    <div className="row d-flex justify-content-center align-items-center h-100">
                        <div className="col-xl-10">
                            ...
                            <div className="mb-5 mt-5 text-center">
                                <h1>Opportunities associated with the current product</h1>
                            </div>
...
export default ListOpportunitiesByProductAdmin;