...
import AddContactAdminSuccessModal from "../modals/contactAdmin/AddContactAdminSuccessModal";


const AddContactAdmin = () => {
                        ...
                        <div className="card-body p-md-5 mx-md-4">
                            ...
                            <div className="card rounded-3 text-black">
                                <div className="row g-0">
                                    ...
                                    <AddContactAdminSuccessModal show={showAddModal} onClose={() => {
                                        ...
                                        <form onSubmit={handleSubmit(submit)}>
                                            ...
                                            <div className="d-flex justify-content-around pt-1 mb-5 mt-5 pb-1">
                                                ...
                                                <button className="btn btn-danger btn-block fa-lg gradient-custom-1 mb-3"
                                                        onClick={() => navigate(`/Dashboard/listContacts/${clientId}`)}>Return to contacts
                                                </button>
...
export default AddContactAdmin;