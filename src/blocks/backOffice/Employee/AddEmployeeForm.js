                    ...
                    <div className="col-xl-10">
                                ...
                                <div className="card-body p-md-5 mx-md-4">
                                    ...
                                    />
                                        ...
                                        <div className="homepage-titles creatAccountTitle mt-5 mb-5">
                                            <h4 className="mt-1 mb-3 pb-1">Create an employee account </h4>
                                            ...
                                            <div className="form-outline col-5 mb-4">
                                                ...
                                                <select className="form-select"{...register("groupId")}>
                                                    ...
                                                    {Array.isArray(groups) ? (
                                                        ...
                                                        // Handle the case when groups is not an array (e.g., loading or empty state)
