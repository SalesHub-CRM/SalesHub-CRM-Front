...
import "./DeleteLeadAdminSuccess.css";


const DeleteLeadAdminSuccess = ({ show, onClose }) => {
    ...
    return (
        ...
        <div className={`deleteLeadAdmin-success-modal ${show ? 'show' : 'hide'}`}>
...
export default DeleteLeadAdminSuccess;