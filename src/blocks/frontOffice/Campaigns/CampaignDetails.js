            ...
            <div>
                ...
                <div className="card-body p-md-5 mx-md-4">
                    ...
                    <div className="d-flex mt-5 mb-5 justify-content-around">
                        ...
                        <div className="mt-5 mb-5">
                            ...
                            <div className="d-flex justify-content-around mt-5 mb-3">
                                <button className="btn btn-success" onClick={() => navigate(`/home/product/productDetails/${Campaign.productObject.id}`)}>See all details</button>
                            </div>
                    ...
                    <div className="d-flex justify-content-around mt-5 mb-5">
                        <button className="btn btn-danger" onClick={() => navigate(`/home/campaign/ListCampByProd/${Campaign.productObject.id}`)}>All Campaigns for this product</button>
                        <button className="btn btn-info" onClick={() => navigate(`/home/campaign/EditCampaign/${campaignId}`)}>Edit this campaign</button>
                    </div>
