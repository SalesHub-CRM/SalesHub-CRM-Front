...
import EditCampaignSuccessModal from "../modals/campaign/EditCampaignSuccessModal";
...
const EditCampaigns = () => {
    ...
    const handleModalClose = () => {
        ...
        navigate(`/home/campaign/CampaignDetails/${campaignId}`);
    };
                        ...
                        <div className="col-xl-10">
                            <div className="card rounded-3 text-black">
                                <div className="row g-0">
                                    ...
                                    <EditCampaignSuccessModal show={isEditSuccess} campaignId={campaignId} onClose={handleModalClose}/>
                                        ...
                                        <form onSubmit={handleSubmit(submit)}>
                                            ...
                                            <div className="d-flex justify-content-around pt-1 mb-5 mt-5 pb-1">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => navigate(`/home/campaign/CampaignDetails/${campaignId}`)}>Back to details
                                                </button>
